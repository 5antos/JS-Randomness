...
function formatTime(time, format, twoDigits=true) {
  ...
  return format.replace(/dd|hh|mm|ss/gi, match => time[formats[match]].toString().padStart(twoDigits ? 2 : 0, '0'))
}


// Example Outputs:

formatTime({ days: 6, hours: 2, minutes: 39, seconds: 48 }, 'dd days, hh hours, mm minutes and ss seconds', false) // 6 days, 2 hours, 39 minutes and 48 seconds
